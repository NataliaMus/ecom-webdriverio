...
class CheckoutPage extends BasePage {
    ...
    get postalCodeInput() { return $('[name="postalCode"]'); }
    get continueButton() { return $('[data-test="continue"]'); }
    get finishButton() { return $('[data-test="finish"]'); }
    get validationError() { return $('[data-test="error"]'); }
    get paymentInformation() { return $('[data-test="payment-info-value"]'); }
    get checkoutItems() { return $('[data-test="inventory-item"]'); }
    get completeOrderHeader() { return $('[data-test="complete-header"]'); }
